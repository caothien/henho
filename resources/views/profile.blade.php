		...
		<div class="col-md-8 col-md-offset-2">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					<div class="fb-like" data-href="http://henhosinhvien.com/profile/{{$profile->created_at}}/{{$profile->id}}" data-width="400" data-layout="standard" data-action="like" data-size="large" data-show-faces="true" data-share="true"></div>

					<div class="fb-comments" data-href="http://henhosinhvien/profile/{{$profile->created_at}}/{{$profile->id}}" data-width="100%" data-numposts="10"></div>
			</div>
		</div>
	</div>
</div>
