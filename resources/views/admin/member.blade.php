	...
	<div class="col-md-8 col-md-offset-2">
		<div class="panel panel-primary">
			...
			@if (session('updateid'))
				...
				@endif
				<form class="form-horizontal" role="form" action="{{ url('/update-idmember') }}" method="post">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input class="form-control" name="newidmember" required>
						</div>
					</div>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label">Cập nhật ID</label>
						<div class="col-sm-10">
